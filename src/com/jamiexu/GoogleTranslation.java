...
public class GoogleTranslation {
    ...
    public String translateTo(String keyWord, String language) {
        String url = "https://translate.google.cn/translate_a/single?client=webapp&sl=auto&tl="
                ...
                getToken(keyWord) + "&q=" + URLEncoder.encode(keyWord, StandardCharsets.UTF_8);
    ...
    public String getToken(String keyWord) {
        ...
        try {
            engine.eval("function token(a) {\n" +
                    ...
                    "    return a\n" +
                    "}");
            return (String) engine.eval("token('" + keyWord + "')");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
